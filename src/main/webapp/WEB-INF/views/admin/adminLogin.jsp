				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="adminLogin.html"><img src="images/home/logo.png" alt="" /></a>
						</div>
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="adminNewProduct.html"><i class="fa fa-user"></i> AddNewProduct</a></li>
								<li><a href="allProduct.html"><i class="fa fa-star"></i> ProductList</a></li>
								<li><a href="updateProduct.html"><i class="fa fa-crosshairs"></i> UpdateProduct</a></li>
								<li><a href="other.html"><i class="fa fa-shopping-cart"></i> Others</a></li>
								<li><a href="logout.html" class="active"><i class="fa fa-lock"></i> Logout</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-sm-2">
						<div class="companyinfo">
							...
							<p>You can get your dream Glass Item</p>
						</div>
					</div>
					<div class="col-sm-7">
						<div class="col-sm-3">
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					...
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.technozip.in">Technozip</a></span></p>
				</div>
			</div>
		</div>
